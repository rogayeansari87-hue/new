...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32639',
            //extent: [529481.934300, 3935975.038300, 539503.149700, 3950921.592500],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([529481.934300, 3935975.038300, 539503.149700, 3950921.592500], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_paygah_gheyre_zamime_5,
    colName: 'LabelID',
    zoom: 10,
    collapsed: true,
    map: map,
